...
const UNIT_LABELS = {
  ...
  chemistry: {
    ...
    U3: 'Intermolecular Forces and Properties',
    U4: 'Chemical Reactions',
    U5: 'Kinetics',
    U6: 'Thermodynamics',
    U7: 'Equilibrium',
    U8: 'Acids and Bases',
    U9: 'Applications of Thermodynamics',
  },
  'computer-science-a': {
    U1: 'Primitive Types',
    U2: 'Using Objects',
    U3: 'Boolean Expressions and if Statements',
    U4: 'Iteration',
    U5: 'Writing Classes',
    U6: 'Array',
    U7: 'ArrayList',
  ...
  statistics: {
    ...
    U2: 'Exploring Two-Variable Data',
    U3: 'Collecting Data',
    U4: 'Probability, Random Variables, and Probability Distributions',
    U5: 'Sampling Distributions',
    U6: 'Inference for Categorical Data: Proportions',
    U7: 'Inference for Quantitative Data: Means',
    U8: 'Inference for Categorical Data: Chi-Square',
    U9: 'Inference for Quantitative Data: Slopes',
  },
  ...
  'physics-2': {
    U1: 'Fluids',
    U2: 'Thermodynamics',
    U3: 'Electric Force, Field, and Potential',
    U4: 'Electric Circuits',
    U5: 'Magnetism and Electromagnetic Induction',
    U6: 'Geometric and Physical Optics',
    U7: 'Quantum, Atomic, and Nuclear Physics',
  },
  'physics-c-mechanics': {
    U1: 'Kinematics',
    U2: 'Force and Translational Dynamics',
